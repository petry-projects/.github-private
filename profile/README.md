...
| [`agent-rate-limits`](https://github.com/petry-projects/.github/blob/main/standards/agent-rate-limits.md) | Per-agent token budget and rate-limit controls | What is limited · The token-budget breaker · Status — signed off and wired (Phase 4) · Exempt actors — sanctioned, not a misconfiguration · Operator runbook |
