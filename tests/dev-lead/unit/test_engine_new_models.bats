...
@test "new-models: CLAUDE_DEEP_MODEL_CHAIN starts with claude-opus-5-5 (#1898)" {
  _source_engine "claude"
  local first
...
@test "new-models: model_for_intent(fix-issue) returns claude-opus-5-5 (#1898)" {
  _source_engine "claude"
  local result
...
@test "new-models: model_for_intent(human) returns claude-opus-5-5 (#1898)" {
  _source_engine "claude"
  local result
...
@test "new-models: deep opus-5-5 rate-limited → sonnet-5-0 tried (#1898)" {
  _source_engine "claude"
...
@test "new-models: action chain sonnet rate-limited → opus-4-8 tried (not opus-4-7)" {
  ...
  export STUB_ENGINE_RESPONSE_BY_MODEL="claude-sonnet-5-0=too many requests|claude-opus-4-8=action done"
