...
setup() {
  ...
  MISS='{"repo":"petry-projects/.github","pr":"https://github.com/petry-projects/.github/pull/995","bot":"coderabbitai","finding":"ADR asserts a rolling 5-hour window while also asserting utilization is monotonic — a self-contradiction. cc @don-petry https://internal.example.com/x token ghp_abcdefghijklmnop"}'
}
...
@test "mh_build_case: strips URLs, @mentions and token-like strings" {
  ...
  ! grep -q "ghp_abcdefghijklmnop" <<<"$output"
