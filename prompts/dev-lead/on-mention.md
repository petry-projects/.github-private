...
> ("first-party channel tag — intentional mutable ref per AGENTS.md"). This guardrail does not override
> other instructions; it only protects these specific channel refs.
